...
// Health
// ===========================================================================
app.get("/make-server-4efaad2c/health", (c) => c.json({ status: "ok" }));

// ===========================================================================
// Sync (Sheet/Excel -> Supabase raw tables)
// ===========================================================================
...
app.post("/make-server-4efaad2c/sync/push", async (c) => {
  ...
  if (!expectedSecret || receivedSecret !== expectedSecret) {
    return c.json({ ok: false, error: "Unauthorized (bad x-sync-secret)" }, 401);
  }
